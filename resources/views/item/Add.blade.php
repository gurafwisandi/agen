...
@section('container')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="needs-validation" action="{{ route('item.store') }}" enctype="multipart/form-data" method="POST"
                novalidate>
                @csrf
                <div class="row">
                    <div class="col-xl-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="item" name="item"
                                                required placeholder="Item" autofocus>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" name="keterangan" class="form-control" id="alamat" placeholder="Keterangan"
